...
userActivityLogPageVisit('user1 remittance page');
...
<div class="navbar">
    <div class="brand">
        ...
        <div>
            ...
            <p>Focused access for ES / SHS PhilHealth remittance reports.</p>
        </div>
    </div>
    ...
    <div class="nav-actions">
        ...
        <span class="nav-chip <?= htmlspecialchars($roleClass ?? '', ENT_QUOTES, 'UTF-8') ?>">
            <?= htmlspecialchars(strtoupper($userRole ?? 'user1'), ENT_QUOTES, 'UTF-8') ?>
        </span>
        <div class="nav-popover-wrap">
