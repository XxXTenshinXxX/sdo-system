...
$pageTitle = 'User1 ES / SHS Remittance Reports';
$activePage = 'es-shs';
$section = 'es-shs';
...
<body>
                        ...
                        <div class="report-table-shell">
                            <table class="table report-summary-table">
                                ...
                                <tbody>
                                    <?php if ($reports === []): ?>
                                        <tr>
                                            <td colspan="10" class="empty-state-cell">No uploaded ES / SHS PDF reports yet.</td>
                                        </tr>
                                    <?php else: ?>
                                                ...
                                                <td class="action-cell">
                                                    <div class="report-action-group">
                                                        <a
                                                            ...
                                                            href="report-employees.php?section=es-shs&amp;file=<?= rawurlencode($storedFileName) ?>"
                                                        ...
                                                        <form method="POST" class="report-delete-form">
                                                            ...
                                                            <input type="hidden" name="report_section" value="es-shs">
        ...
        <div class="report-upload-dialog" role="dialog" aria-modal="true" aria-labelledby="uploadModalTitle">
            <div class="report-upload-dialog-head">
                <div>
                    ...
                    <h3 id="uploadModalTitle">Upload ES / SHS Remittance PDF</h3>
            ...
            <form method="POST" enctype="multipart/form-data" class="report-upload-form report-upload-form-modal">
                ...
                <label for="esShsReportPdf" class="upload-dropzone" id="uploadDropzone">
                    <input type="file" id="esShsReportPdf" name="report_pdf[]" accept=".pdf,application/pdf" class="upload-file-input" multiple required>
    ...
    <div class="report-delete-modal" id="reportDeleteModal" hidden>
        ...
        <div class="report-delete-dialog" role="dialog" aria-modal="true" aria-labelledby="deleteModalTitle">
            <div class="report-delete-dialog-head">
                <div>
                    <span class="delete-modal-kicker">Delete Request</span>
                    <h3 id="deleteModalTitle">Send delete request for this PDF report?</h3>
                    <p>This report will stay in the system until an admin or user3 approves your request.</p>
                </div>
    ...
    <div class="report-delete-modal" id="bulkDeleteModal" hidden>
        ...
        <div class="report-delete-dialog" role="dialog" aria-modal="true" aria-labelledby="bulkDeleteModalTitle">
            <div class="report-delete-dialog-head">
                <div>
                    <span class="delete-modal-kicker">Bulk Delete Request</span>
                    <h3 id="bulkDeleteModalTitle">Send delete request for selected PDF reports?</h3>
    ...
    <script>
        ...
        const uploadFileInput = document.getElementById('esShsReportPdf');
