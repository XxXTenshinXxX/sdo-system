<aside class="sidebar">
    <div>
        ...
        <nav class="menu">
            ...
            <a href="qes.php" class="<?= ($activePage ?? '') === 'qes' ? 'active' : '' ?>">
    ...
    <div class="modal-card confirm-logout-card">
        <div class="confirm-logout-hero">
            ...
            <div>
                ...
                <h3>Logout from Admin Dashboard?</h3>
                <p>Your admin session will end and you will be redirected to the login page.</p>
            </div>
        </div>
